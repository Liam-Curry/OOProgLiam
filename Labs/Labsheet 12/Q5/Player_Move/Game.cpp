...
void Game::checkKeyboardState()
{
	...
	{
		m_myPlayer.changeDirection(NORTH);
		m_myPlayer.move();
	}

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Down))
	{
		m_myPlayer.changeDirection(SOUTH);
		m_myPlayer.move();
	}

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Left))
	{
		m_myPlayer.changeDirection(WEST);
		m_myPlayer.move();
	}

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::Right))
	{
		m_myPlayer.changeDirection(EAST);
		m_myPlayer.move();
	}
...
void Game::update(sf::Time t_deltaTime)
{
	...
	m_randEnemy.changeDirection();
	m_randEnemy.randomSpeed();
}
...
void Game::render()
{
	...
	m_window.draw(m_randEnemy.getBodyRand());
	m_window.display();
}
