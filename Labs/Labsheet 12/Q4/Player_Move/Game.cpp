...
void Game::processKeys(const std::optional<sf::Event> t_event)
{
	...
	{
		m_dice2Roll = m_gameDice2.rollDice();
		m_dice2Check = true;
	}
}
...
void Game::update(sf::Time t_deltaTime)
{
	...
	m_dice2.setString("Dice 2 number is: " + std::to_string(m_dice2Roll));
...
void Game::setupTexts()
{
	...
	m_dice2.setFont(m_font);
	m_dice2.setPosition(sf::Vector2f{ 20.0f,160.0f });
	m_dice2.setCharacterSize(50U);
	m_dice2.setOutlineColor(sf::Color::Black);
	m_dice2.setFillColor(sf::Color::Blue);
	m_dice2.setOutlineThickness(2.0f);
